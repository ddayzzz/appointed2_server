...
def _make_app(dbusername, dbpasswd, dbname, dbhost, dbport, log_level):
    """
...
def SampleApp(dbusername, dbpasswd, dbname, dbhost, dbport, log_level='info'):
    """
    ...
    async def gunicron_need_callable():
        return _make_app(dbusername, dbpasswd, dbname, dbhost, dbport, log_level)
